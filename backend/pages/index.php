                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="display:flex;column-gap:5px;">
                                                <a href="index.php?route=pages/edit&id=<?= $page['id'] ?>" title="Edit" class="btn btn-sm btn-primary pull-right">
                                                    <i class="voyager-paper-plane">Edit</i>
                                                </a>
                                                <a href="index.php?route=pages/delete&id=<?= $page['id'] ?>" title="Delete" class="btn btn-sm btn-danger pull-right">
